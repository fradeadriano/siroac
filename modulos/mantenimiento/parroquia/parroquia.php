		...
		<td>
			<table width="99%" align="center" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td class="titulomenu" valign="middle">Registro Parroquia</td>
				</tr>
				<tr>
		...
		<td>
			<table align="center" width="100%" border="0">
				<tr>
					<td>
						<fieldset>
						<legend class="titulomenu">&nbsp;Datos de la Parroquia</legend>
							...
							<table align="center" width="80%"  border="0" cellspacing="0"  cellpadding="5">			
                                ...
                                <tr >
									...
									<td>
										<? 
										$rses = new Recordset();
										$rses->sql = "SELECT id_municipio, municipio FROM municipio order by municipio"; 
										$rses->llenarcombo($opciones = "\"municipio\"", $checked = "", $fukcion = "" , $diam = "style=\"width:326px; Height:20px;\""); 
										$rses->cerrar(); 
										unset($rses);																						
										?>&nbsp;<span class="mensaje">*</span>
									</td>
								...
								<tr>
									...
									<td>
										<input type="text" name="parroquia" id="parroquia" style="width:320px" onkeypress="return validar(event,letras+'ñ')" >&nbsp;<span class="mensaje">*</span>
									</td>
								</tr>
								...
								<tr>
									<td align="center" colspan="5">
										...
										&nbsp;
										<input type="button" name="buscar" id="buscar" value="Buscar" title="Buscar" onclick="displayMessage('modulos/mantenimiento/parroquia/bsq.php','750','500');" />																				
									</td>
								</tr>																																								
							</table>
							</form>
...
<? echo '<script language="javascript" type="text/javascript">cargar_lista("'.'modulos/mantenimiento/parroquia/parroquia_d.php?pagina=1'.'");</script>'; ?>
<script language="javascript" type="text/javascript">
$(document).ready(function()
{
	...
	if(valor==1){
		...
		mensaje=acentos('&iexcl;La Parroquia ha sido registrada exitosamente!')
	...
	if(valor==2){
		...
		mensaje=acentos('&iexcl;Registro Rechazado, La Parroquia ha sido registrada anteriormente!')
	...
	if(valor==3){
		...
		mensaje=acentos('&iexcl;Actualizaci&oacute;n Fallida, La Parroquia ya se encuentra registrada!')
		$("#mensa").addClass('fallo');
		$('#mensa').html(mensaje);
	}	
	...
	if(valor==4){
		...
		mensaje=acentos('&iexcl;Actualizaci&oacute;n Exitosa, La Parroquia fue Actualizada exitosamente!')
		$("#mensa").addClass('exito');
		$('#mensa').html(mensaje);
	}		
	...
	if(valor==6){
		...
		mensaje=acentos('&iexcl;Eliminaci&oacute;n de la Parroquia exitosa!')
		$("#mensa").addClass('exito');
		$('#mensa').html(mensaje);
	}		
	...
	if(valor==7){
		...
		mensaje=acentos('&iexcl;La Parroquia no se elimino por estar vinculado con otra entidad!')
		$("#mensa").addClass('exito');
		$('#mensa').html(mensaje);
	}
	...
	if(valor==8){
		...
		mensaje=acentos('&iexcl;Verifique, No ha realizado ninguna eliminaci&oacute;n de la Parroquia!')
		$("#mensa").addClass('exito');
		$('#mensa').html(mensaje);
	}		
