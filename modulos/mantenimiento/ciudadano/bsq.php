		...
		<td align="center">
			...
			<table class="texto" width="500"  align="center" border="0">
				<tr>
					<td align="center"> 
					<td> 
						C&eacute;dula:<input type="radio" name="selec" id="ced" checked="checked" />
...
<? echo '<script language="javascript" type="text/javascript">cargar_lista_bsq("'.'modulos/mantenimiento/ciudadano/bsq_list.php?pagina=1'.'");</script>'; ?>