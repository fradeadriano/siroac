...
$rsli->sql = "SELECT ciudadano.id_ciudadano, ciudadano.cedula, CONCAT(ciudadano.nombres,', ',ciudadano.apellidos) AS nombre, 
					ciudadano.telf_habitacion as thabitacion, ciudadano.telf_movil AS tmovil 
...
?>
    <tr<? if($i % 2 == 0) echo " class=\"trresaltado\"" ?>>
        ...
        <td align="center"><? if ($rsli->fila["thabitacion"]=="") { echo $rsli->fila["tmovil"]; } else { echo $rsli->fila["tmovil"]." // ".$rsli->fila["thabitacion"]; } ?></td>
        <td align="center">
