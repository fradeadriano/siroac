			...
			if(isset($_POST["accion"]))
			{
				switch($_POST["accion"])
				{
					case "Registrar": 
						...
						// D-CC-000-00-0000-OAC-CEA	  rssolicitud															
						...
						$ins->sql = "INSERT INTO registro_mecanismo($campos_, fecha_registro, n_expediente, sub_tipo_mecanismo)
										VALUES ($values_, '".date("Y-m-d")."', '$codnuevo', 'ac')"; // ac asesoria comun
						$ins->abrir();
						$ins->cerrar();
						unset($ins);		
						/*bitacora*/ 
						...
						/*bitacora*/ 
							bitacora($_SESSION["usuario"],date("Y-m-d"),date("H:i:s"),"Registro una Petici&oacute;n Caso identificado con n&uacute;mero: $mYId","Se registro una Petici&oacute;n Caso con id: -$mYId- y con los siguientes datos: '".$bti."'.");
						/*bitacora*/
						//?calificacion='.$if.'
						$mensaje = 1;
						 /* echo '<script language="javascript">window.open("modulos/mecanismo/peticion/caso/pdf_denuncia.php?mecanismo='.$mYId.'","Reporte","location=1,scrollbars=0,width=1000,height=700");</script>'; */																			
						echo '<form action="modulos/mecanismo/peticion/caso/xls_caso.php" method="get" name="repor_caso" id="repor_caso">
								<input type="hidden" name="mecanismo" id="mecanismo" >
							 </form>';
						echo '<script language="javascript"> document.getElementById("mecanismo").value = "'.$mYId.'"; document.getElementById("repor_caso").target="_blank"; document.repor_caso.submit(); </script>';																			
		...
		<td align="right">
			<table width="100%" align="center" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td class="titulomenu" valign="middle">Registro de Petici&oacute;n: Caso &oacute; Asesoria</td>
				</tr>
				<tr>
			...
			<fieldset>
				...
				<table border="0" width="100%">
							...
							<table border="0" cellpadding="0" cellspacing="3" width="100%" id="contenedor">
								<tr>
									<td colspan="6" align="right" valign="middle">
										...
										<img src="images/Find.png" title="Busqueda de Ciudadanos"onclick="displayMessage('modulos/mecanismo/peticion/caso/bsq.php','750','500');" style="cursor:pointer"/>
										&nbsp;&nbsp;&nbsp;<img src="images/agre_ciudadano.png" title="Agregar un Nuevo Ciudadano"onclick="displayMessage('modulos/mecanismo/peticion/caso/ciudadano.php','750','550');" style="cursor:pointer"/>
										&nbsp;&nbsp;
									</td>
								</tr>
					...
					<tr>
						<td colspan="2" align="center">
							...
							<table border="0" cellpadding="3"  cellspacing="3" width="100%" id="contenedor" style="display:">
								...
								<tr>
									<td align="right" valign="top">Rif.:</td><td align="left"><input type="text" name="rif_instancia" id="rif_instancia" onkeypress="return validar(event,numeros+'JjgG-')" onkeyup="mascara(this,'-',patron3,false)" maxlength="15" style="width:150px"/>
						...
						<td colspan="2" align="center">
							...
							<table border="0" cellpadding="3"  cellspacing="3" width="100%" id="contenedor" style="display:">
								...
								<tr>
									...
									<td align="right" valign="top">Otro Telf.:</td>
								  <td align="left" valign="top"><input type="text" name="otr_telef_organizacion" id="otr_telef_organizacion" style="width:87px" onkeypress="return validar(event,numeros+'-')" onkeyup="mascara(this,'-',p_telefonico,false)"/>								    &nbsp;&nbsp;&nbsp;
								  <br /><span style="font-size:9px">Ejm. 0243-01234567</span></td>																										
								</tr>
					...
					<tr>
						<td colspan="2" align="center">
							<fieldset style="width:98%">
							<legend class="titulomenu">Tramite, Narraci&oacute;n de los Presuntos Actos, Hechos u Omisiones</legend>
							<table border="0" cellpadding="0" cellspacing="3" width="100%">
								<tr>
									<td colspan="6" align="right" valign="middle">
							...
							<table border="0" cellpadding="3"  cellspacing="3" width="100%" id="contenedor" style="display:">
								<tr ><td height="5"></td></tr>
								<tr>
									<td align="right" valign="top"><textarea name="narracion_hechos" id="narracion_hechos" onblur="formatotexto(this);" style="width:710px; height:350px" ></textarea>&nbsp;<span class="mensaje">*</span></td>
								</tr>								
					...
					<tr>
						<td colspan="2" align="center">
							...
							<table border="0" cellpadding="3"  cellspacing="3" width="100%" id="contenedor" style="display:">
								<tr ><td height="5"></td></tr>
								<tr>
									<td align="right" valign="top"><textarea name="observacion_hechos" id="observacion_hechos" onblur="formatotexto(this);" style="width:710px; height:350px" ></textarea>&nbsp;<span class="mensaje">*</span></td>
								</tr>								
								<tr><td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:9px">M&aacute;ximo 2000 Caracteres</span></td></tr>
								<tr><td height="3" class="mensaje" align="right">* Campo Obligatorio</td></tr>
							</table></div>						
...
$(document).ready(function()
{
	...
	if(valor==1){
		...
		mensaje=acentos('&iexcl;La Petici&oacute;n de Caso ha sido registrado Exitosamente!')
