...
function busq_formal(a1,a2){ 
	var My_path = "modulos/mecanismo/peticion/caso/bsq_list.php?pagina=1&pa1="+a1+"&pa2="+a2;
	var spasc = mostrarContenido3;
	llamarlistado(My_path,spasc);
}
...
function cargar_parroquias(My_param){
	var My_path = "modulos/mecanismo/peticion/caso/c.parroquia.php?mY_id_municipio="+My_param;
...
/*	if (document.getElementById("thabitacion").value == ""){
	...
	if (document.getElementById("id_municipio").value == ""){
		...
		return document.getElementById("id_municipio").focus();
	}
	...
	//var My_Second_path = "modulos/mecanismo/peticion/caso/save_ciudadano.php"+$valores;
	//var spasc = mostrarContenido4;
	//llamarlistado(My_Second_path,spasc);
	window.frames.salvar_ciudadano.location.href="modulos/mecanismo/peticion/caso/save_ciudadano.php"+$valores;
...
function validacion() 
{
	if (document.getElementById("comunicacion").value == "" || /^\s+$/.test(document.getElementById("comunicacion").value)){		
			alert(acentos("Seleccione una Comunicaci&oacute;n!!"));
			document.getElementById("comunicacion").focus;
			return false;
		}
...
function cargar_municipos(My_param,selec){
	var My_path = "modulos/mecanismo/peticion/asesoria/c.municipio.php?mY_id_estado="+My_param;
