					...
					<td>
						...
						<legend class="titulomenu">&nbsp;Datos del Ciudadano</legend>
							...
							<table align="center" width="80%"  border="0" cellspacing="0"  cellpadding="3">											
								...
								<tr style="display:none"><td><iframe width="250" height="250" src="modulos/mecanismo/peticion/caso/save_ciudadano.php" name="salvar_ciudadano" id="salvar_ciudadano" frameborder="1"  />a</td></tr>
							</table>
							</form>								
						</fieldset>						
					</td>
