...
//				$thabitacion = stripslashes($_GET["thabitacion"]);			
				...
				if (isset($_GET["odireccion"]) && stripslashes($_GET["odireccion"])!= "") {
					if($campo_odireccion !=""){
						...
						$odireccion = $odireccion.", '".$rssolicitud->codificar($_GET["odireccion"])."'"; 
					} else {
				...
				if (isset($_GET["email"]) && stripslashes($_GET["email"])!= "") {
					if($campo_odireccion !=""){
						...
						$odireccion = $odireccion.", '".$rssolicitud->codificar($_GET["email"])."'"; 
					} else {
