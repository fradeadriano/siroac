				...
				switch($_POST["accion"])
				{
					case "Registrar": 
						...
						if(isset($_POST["asesoria"])){ 
							if($_POST["asesoria"]==0){
								$f= "Funcionarios &oacute; Empleados P&uacute;blicos";
							}else{
								$f= "Miembros de Organizaci&oacute;n Sindical, Gremial &oacute; Consejo comunal";
							}
							$campos_ = $campos_.", asesoria"; 
							$values_ = $values_.", '".$f."'"; 
							
							if($bti!=""){
								$bti = $bti.", Asesor&iacute;a a: ".stripslashes($_POST["asesoria"]);
							} else {
								$bti = " Asesor&iacute;a a: ".stripslashes($_POST["asesoria"]);
							}							
						}
						...
						if(isset($_POST["ente_financiero"])){ 
							...
							$values_ = $values_.", '".$rssolicitud->codificar($_POST["ente_financiero"])."'"; 
							if($bti!=""){
						...
						if(isset($_POST["fecha_hechos"])){ 
							...
							$values_ = $values_.", '".$_POST["fecha_hechos"]."'";
							if($bti!=""){
						...
						$rssolicitud->sql = "SELECT n_expediente FROM registro_mecanismo WHERE id_mecanismo = 2 AND DATE_FORMAT(fecha_registro,'%Y') = '".date("Y")."' ORDER BY id_registro_mecanismo DESC LIMIT 1";
						$rssolicitud->abrir();
						if($rssolicitud->total_registros > 0)
							{	
								...
								if ($codviejo[4] == $fechanueva)
								{
									...
									$codnuevo= "P-".$pertenece."-".$nuevovalor."-".date("m")."-".$fechanueva."-OAC-CEA";
								}
								else
								{
						...
						$ins = new Recordset();
						$ins->sql = "INSERT INTO registro_mecanismo($campos_, fecha_registro, n_expediente, sub_tipo_mecanismo)
										VALUES ($values_, '".date("Y-m-d")."', '$codnuevo', 'djp')";
						$ins->abrir();
						$ins->cerrar();
						unset($ins);								
						...
						/*bitacora*/ 
							bitacora($_SESSION["usuario"],date("Y-m-d"),date("H:i:s"),"Registro una Asesor&iacute;a DJP identificada con n&uacute;mero: $mYId","Se registro una Asesor&iacute;a DJP con id: -$mYId- y con los siguientes datos: '".$bti."'.");
						/*bitacora*/ 	
												
						//?calificacion='.$if.'
						$mensaje = 1;
						 /* echo '<script language="javascript">window.open("modulos/mecanismo/peticion/asesoria/pdf_denuncia.php?mecanismo='.$mYId.'","Reporte","location=1,scrollbars=0,width=1000,height=700");</script>';*/
						echo '<form action="modulos/mecanismo/peticion/asesoria/xls_asesoria.php" method="get" name="repor_asesoria" id="repor_asesoria">
								<input type="hidden" name="mecanismo" id="mecanismo" >
							 </form>';
						echo '<script language="javascript"> document.getElementById("mecanismo").value = "'.$mYId.'"; document.getElementById("repor_asesoria").target="_blank"; document.repor_asesoria.submit(); </script>';																			
		...
		<td align="right">
			<table width="100%" align="center" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td class="titulomenu" valign="middle">Registro de Petici&oacute;n: Asesor&iacute;a DJP</td>
				</tr>
				<tr>
						...
						<td valign="top" align="center"><br />
							<table border="0" cellpadding="3" cellspacing="3" id="contenedor" style="width:620px;" >
								<tr>
									...
									<td colspan="7"><select name="asesoria" id="asesoria" style="width:250">
											<option selected="selected"></option>
											<option value="0">Funcionarios &oacute; Empleados P&uacute;blicos</option>
											<option value="1">Miembros de Organizaci&oacute;n Sindical, Gremial &oacute; Consejo comunal</option>
							...
							<table border="0" cellpadding="0" cellspacing="3" width="100%" id="contenedor">
								<tr>
								  <td colspan="6" align="right" valign="middle">
										...
										<img src="images/Find.png" title="Busqueda de Ciudadanos"onclick="displayMessage('modulos/mecanismo/peticion/asesoria/bsq.php','750','500');" style="cursor:pointer"/>
										&nbsp;&nbsp;&nbsp;<img src="images/agre_ciudadano.png" title="Agregar un Nuevo Ciudadano"onclick="displayMessage('modulos/mecanismo/peticion/asesoria/ciudadano.php','750','550');" style="cursor:pointer"/>
										&nbsp;&nbsp;
									</td>
								</tr>
					...
					<tr>
						<td colspan="2" align="center">
							...
							<table border="0" cellpadding="3"  cellspacing="3" width="100%" id="contenedor" style="display:">
								...
								<tr>
									<td align="right">Rif.:</td><td align="left"><input type="text" name="rif_instancia" id="rif_instancia" onkeypress="return validar(event,numeros+'JjgG-')" onkeyup="mascara(this,'-',patron3,false)" maxlength="15" style="width:150px"/>
						...
						<td colspan="2" align="center">
							...
							<table border="0" cellpadding="3"  cellspacing="3" width="100%" id="contenedor" style="display:">
								...
								<tr>
									...
									<br /><span style="font-size:9px">Ejm. G-0123456789</span></td>
									<td align="right" valign="top">Telf. Oficina:</td><td align="left" valign="top"><input type="text" name="telef_organizacion" id="telef_organizacion" style="width:87px" onkeypress="return validar(event,numeros+'-')" onkeyup="mascara(this,'-',p_telefonico,false)"/>&nbsp;<span class="mensaje">*</span>
									<br /><span style="font-size:9px" valign="top">Ejm. 0243-01234567</span></td>
					...
					<tr>
						<td colspan="2" align="center">
							...
							<table border="0" cellpadding="3"  cellspacing="3" width="100%" id="contenedor" style="display:">
								<tr ><td height="5"></td></tr>
								<tr>
									<td align="right" valign="top"><textarea name="narracion_hechos" id="narracion_hechos" onblur="formatotexto(this);" style="width:710px; height:350px" >Solicitud de Asesor&iacute;a en Materia de Declaracion Jurada de Patrimonio.</textarea>&nbsp;<span class="mensaje">*</span></td>
								</tr>								
								<tr><td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:9px">M&aacute;ximo 2000 Caracteres</span></td></tr>
								<tr><td height="3" class="mensaje" align="right">* Campo Obligatorio</td></tr>
							</table></div>						
							</fieldset>
						</td>
					...
					<tr>
						<td colspan="2" align="center">
							...
							<table border="0" cellpadding="3"  cellspacing="3" width="100%" id="contenedor" style="display:">
								<tr ><td height="5"></td></tr>
								<tr>
									<td align="right" valign="top"><textarea name="observacion_hechos" id="observacion_hechos" onblur="formatotexto(this);" style="width:710px; height:350px">El Ciudadano solicitó asesoría en materia de Declaración Jurada de Patrimonio, en este sentido se le brindó la asesoría correspondiente en cuanto A: orientaciones técnicas sobre registro, requisitos y elaboración de la misma, de conformidad con las disposiciones de la Ley Contra la Corrupción a través del Sistema Online de la Contraloría General de la República.</textarea>&nbsp;<span class="mensaje">*</span></td>
								</tr>								
								<tr><td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:9px">M&aacute;ximo 2000 Caracteres</span></td></tr>
								<tr><td height="3" class="mensaje" align="right">* Campo Obligatorio</td></tr>
							</table></div>						
...
$(document).ready(function()
{
	...
	if(valor==1){
		...
		mensaje=acentos('&iexcl;La Petici&oacute;n de Asesoria ha sido registrada Exitosamente!')
