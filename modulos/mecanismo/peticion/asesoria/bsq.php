		...
		<td align="center">
			...
			<table class="texto" width="500"  align="center" border="0">
				<tr>
					<td align="center"> 
					<td> 
						C&eacute;dula:<input type="radio" name="selec" id="cedul" checked="checked" />
						&nbsp;Apellido:<input type="radio" name="selec" id="apelli" />
						&nbsp;
						Nombre:&nbsp;<input type="radio" name="selec" id="nombr"/>
                        &nbsp;&nbsp;&nbsp;&nbsp;
...
<? echo '<script language="javascript" type="text/javascript">cargar_lista_bsq("'.'modulos/mecanismo/peticion/asesoria/bsq_list.php?pagina=1'.'");</script>'; ?>