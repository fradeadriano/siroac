...
function busq_formal(a1,a2){ 
	var My_path = "modulos/mecanismo/peticion/asesoria/bsq_list.php?pagina=1&pa1="+a1+"&pa2="+a2;
	var spasc = mostrarContenido3;
	llamarlistado(My_path,spasc);
}
...
function cargar_parroquias(My_param){
	var My_path = "modulos/mecanismo/peticion/asesoria/c.parroquia.php?mY_id_municipio="+My_param;
...
function subb()
{
	...
	window.frames.salvar_ciudadano.location.href="modulos/mecanismo/peticion/asesoria/save_ciudadano.php"+$valores;
