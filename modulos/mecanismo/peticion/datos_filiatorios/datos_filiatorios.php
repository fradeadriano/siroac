				...
				switch($_POST["accion"])
				{
					case "Registrar": 
						...
						$ins->sql = "INSERT INTO registro_mecanismo($campos_, fecha_registro, n_expediente, sub_tipo_mecanismo)
										VALUES ($values_, '".date("Y-m-d")."', '$codnuevo','df')";
						$ins->abrir();
						$ins->cerrar();
						unset($ins);								
						...
						echo '<form action="modulos/mecanismo/peticion/datos_filiatorios/xls_datos_filiatorios.php" method="get" name="repor_asesoria" id="repor_asesoria">
		...
		<td align="right">
			<table width="100%" align="center" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td class="titulomenu" valign="middle">Registro de Datos Filiatorios</td>
				</tr>
				<tr>
							...
							<table border="0" cellpadding="0" cellspacing="3" width="100%" id="contenedor">
								<tr>
								  <td colspan="6" align="right" valign="middle">
										...
										<img src="images/Find.png" title="Busqueda de Ciudadanos"onclick="displayMessage('modulos/mecanismo/peticion/datos_filiatorios/bsq.php','750','500');" style="cursor:pointer"/>
										&nbsp;&nbsp;&nbsp;<img src="images/agre_ciudadano.png" title="Agregar un Nuevo Ciudadano"onclick="displayMessage('modulos/mecanismo/peticion/datos_filiatorios/ciudadano.php','750','550');" style="cursor:pointer"/>
										&nbsp;&nbsp;
									</td>
								</tr>
					...
					<tr>
						<td colspan="2" align="center">
							...
							<table border="0" cellpadding="3"  cellspacing="3" width="100%" id="contenedor" style="display:">
								<tr ><td height="5"></td></tr>
								<tr>
									<td align="right" valign="top"><textarea name="narracion_hechos" id="narracion_hechos" onblur="formatotexto(this);" style="width:710px; height:350px" >Asesoría relacionada con solicitud de Datos Filiatorios ante el Servicio Administrativo de Identificación, Migración y Extranjería (SAIME).</textarea>&nbsp;<span class="mensaje">*</span></td>
								</tr>								
					...
					<tr>
						<td colspan="2" align="center">
							...
							<table border="0" cellpadding="3"  cellspacing="3" width="100%" id="contenedor" style="display:">
								<tr ><td height="5"></td></tr>
								<tr>
									<td align="right" valign="top"><textarea name="observacion_hechos" id="observacion_hechos" onblur="formatotexto(this);" style="width:710px; height:350px">Con relación al caso planteado, el ciudadano realizó el trámite de los Datos Filiatorios ante el SAIME, y cumplido este paso solicitó ante esta oficinacanalizar dicha información ante la Contraloría General de la República, a fin de realizar su Declaración Jurada de Patrimonio.</textarea>&nbsp;<span class="mensaje">*</span></td>
								</tr>								
								<tr><td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:9px">M&aacute;ximo 2000 Caracteres</span></td></tr>
								<tr><td height="3" class="mensaje" align="right">* Campo Obligatorio</td></tr>
							</table></div>						
