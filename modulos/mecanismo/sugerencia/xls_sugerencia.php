...
$objPHPExcel->getProperties()->setCreator("Adriano Frade")
							 ...
							 ->setTitle("Mecanismos Participacion: Sugerencia")
							 ->setSubject("Siroac")
...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('D7', "SUGERENCIA");						
$objPHPExcel->getActiveSheet()->setTitle('Sugerencia');
...
header('Content-Disposition: attachment;filename="sugerencia_'.$n_expediente.'_'.date('d-m-Y').'.xlsx"');
