...
$rsli->sql = "SELECT ciudadano.id_ciudadano, ciudadano.cedula, CONCAT(ciudadano.nombres,', ',ciudadano.apellidos) AS nombres, 
					IF(ISNULL(ciudadano.telf_habitacion),ciudadano.telf_movil,CONCAT(ciudadano.telf_movil,' / ',ciudadano.telf_habitacion)) AS telefono, ciudadano.direccion 
...
?>
    <tr>
    	<td colspan="4"><? $rsli->CrearPaginadorAjax("modulos/mecanismo/sugerencia/bsq_list.php","images/paginador/","cargar_lista_bsq",$condi) ?></td>
    </tr>
<?
	unset($rsli);
}else{
