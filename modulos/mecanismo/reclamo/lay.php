...
function busq_formal(a1,a2){ 
	var My_path = "modulos/mecanismo/reclamo/bsq_list.php?pagina=1&pa1="+a1+"&pa2="+a2;
	var spasc = mostrarContenido3;
	llamarlistado(My_path,spasc);
}
...
function cargar_parroquias(My_param){
	var My_path = "modulos/mecanismo/reclamo/c.parroquia.php?mY_id_municipio="+My_param;
...
/*	if (document.getElementById("thabitacion").value == ""){
	...
	if (document.getElementById("tmovil").value == ""){
		alert(acentos("Debe colocar el tel&eacute;fono m&oacute;vil del ciudadano"));
	...
	//var My_Second_path = "modulos/mecanismo/reclamo/save_ciudadano.php"+$valores;
	//var spasc = mostrarContenido4;
	//llamarlistado(My_Second_path,spasc);
	window.frames.salvar_ciudadano.location.href="modulos/mecanismo/reclamo/save_ciudadano.php"+$valores;
...
function cargar_municipos(My_param,selec){
	var My_path = "modulos/mecanismo/reclamo/c.municipio.php?mY_id_estado="+My_param;
