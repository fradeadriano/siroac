...
$objPHPExcel->getProperties()->setCreator("Adriano Frade")
							 ...
							 ->setTitle("Mecanismos Participacion: Reclamo")
							 ->setSubject("Siroac")
							 ->setDescription("Reclamos")
							 ->setKeywords("Reporte")
							 ->setCategory("Reporte");
...
header('Content-Disposition: attachment;filename="reclamos_'.$n_expediente.'_'.date('d-m-Y').'.xlsx"');
