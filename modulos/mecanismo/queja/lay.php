...
function busq_formal(a1,a2){ 
	var My_path = "modulos/mecanismo/queja/bsq_list.php?pagina=1&pa1="+a1+"&pa2="+a2;
	var spasc = mostrarContenido3;
	llamarlistado(My_path,spasc);
}
...
function cargar_parroquias(My_param){
	var My_path = "modulos/mecanismo/queja/c.parroquia.php?mY_id_municipio="+My_param;
...
/*	if (document.getElementById("thabitacion").value == ""){
	...
	if (document.getElementById("municipio").value == ""){
		alert(acentos("Debe especificar el municipiodonde vive el ciudadano"));
	...
	//var My_Second_path = "modulos/mecanismo/queja/save_ciudadano.php"+$valores;
	//var spasc = mostrarContenido4;
	//llamarlistado(My_Second_path,spasc);
	window.frames.salvar_ciudadano.location.href="modulos/mecanismo/queja/save_ciudadano.php"+$valores;
...
function cargar_municipos(My_param,selec){
	var My_path = "modulos/mecanismo/queja/c.municipio.php?mY_id_estado="+My_param;
