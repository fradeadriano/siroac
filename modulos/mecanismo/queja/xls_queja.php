...
$objPHPExcel->getProperties()->setCreator("Adriano Frade")
							 ...
							 ->setTitle("Mecanismos Participacion: Queja")
							 ->setSubject("Siroac")
							 ->setDescription("Queja")
							 ->setKeywords("Reporte")
							 ->setCategory("Reporte");
...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('D7', "QUEJA");						
$objPHPExcel->getActiveSheet()->setTitle('Queja');
...
header('Content-Disposition: attachment;filename="queja_'.$n_expediente.'_'.date('d-m-Y').'.xlsx"');
