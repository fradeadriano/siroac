					...
					<td>
						...
						<legend class="titulomenu">&nbsp;Datos del Ciudadano</legend>
							...
							<table align="center" width="80%"  border="0" cellspacing="0"  cellpadding="3">											
								...
								<tr style="display:none; width:400px; height:400px"><td><iframe src="modulos/mecanismo/denuncia/save_ciudadano.php" name="salvar_ciudadano" id="salvar_ciudadano" frameborder="1"  /></td></tr>
							</table>
							</form>								
						</fieldset>						
					</td>
