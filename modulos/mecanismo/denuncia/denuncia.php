			...
			if(isset($_POST["accion"]))
			{
				switch($_POST["accion"])
				{
					case "Registrar": 
						...
						$rssolicitud->sql = "SELECT n_expediente FROM registro_mecanismo WHERE id_mecanismo = 1 AND DATE_FORMAT(fecha_registro,'%Y') = '".date("Y")."' ORDER BY id_registro_mecanismo DESC LIMIT 1";
						$rssolicitud->abrir();
						if($rssolicitud->total_registros > 0)
							{	
								...
								if ($codviejo[4] == $fechanueva)
								{
									...
									$codnuevo= "D-".$pertenece."-".$nuevovalor."-".date("m")."-".$fechanueva."-OAC-CEA";
								}
								else
								{
						...
						/*bitacora*/ 
							...
							bitacora($_SESSION["usuario"],date("Y-m-d"),date("H:i:s"),"Registro una Denuncia identificada con n&uacute;mero: $mYId","Se registro una Denuncia con id: -$mYId- y con los siguientes datos: '".$bti."'.");
						/*bitacora*/ 								
						
						//?calificacion='.$if.'
						$mensaje = 1;
						/* echo '<script language="javascript">window.open("modulos/mecanismo/denuncia/xls_denuncia.php?mecanismo='.$mYId.'","Reporte","location=1,scrollbars=0,width=1000,height=700");</script>'; */																			
						echo '<form action="modulos/mecanismo/denuncia/xls_denuncia.php" method="get" name="repor_denuncia" id="repor_denuncia">
								<input type="hidden" name="mecanismo" id="mecanismo" >
							 </form>';
						echo '<script language="javascript"> document.getElementById("mecanismo").value = "'.$mYId.'"; document.getElementById("repor_denuncia").target="_blank"; document.repor_denuncia.submit(); </script>';																			
		...
		<td align="right">
			<table width="100%" align="center" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td class="titulomenu" valign="middle">Registro de Denuncias</td>
				</tr>
				<tr>
							...
							<table border="0" cellpadding="0" cellspacing="3" width="100%" id="contenedor">
								<tr>
									<td colspan="6" align="right" valign="middle">
										...
										<img src="images/Find.png" title="Busqueda de Ciudadanos"onclick="displayMessage('modulos/mecanismo/denuncia/bsq.php','750','500');" style="cursor:pointer"/>
										&nbsp;&nbsp;&nbsp;<img src="images/agre_ciudadano.png" title="Agregar un Nuevo Ciudadano"onclick="displayMessage('modulos/mecanismo/denuncia/ciudadano.php','750','550');" style="cursor:pointer"/>
										&nbsp;&nbsp;
									</td>
								</tr>
					...
					<tr>
						<td colspan="2" align="center">
							...
							<table border="0" cellpadding="3"  cellspacing="3" width="100%" id="contenedor" style="display:">
								<tr ><td height="5"></td></tr>
								<tr>
									<td align="right" width="170">Instancia del Poder Popular:</td><td colspan="3"><input type="text" name="instancia_pp" id="instancia_pp" style="width:530px" onkeypress="return validar(event,letras+'ñ')" />&nbsp;<span class="mensaje">*</span></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td align="right" valign="top">Ente Financiero:</td><td align="left" valign="top"><input type="text" name="ente_financiero" id="ente_financiero" onkeypress="return validar(event,letras)" maxlength="35" style="width:208px"/></td																	
								></tr>
								<tr>
									<td align="right" width="170">Nombre del Proyecto:</td><td colspan="3"><input type="text" name="nombre_proy" id="nombre_proy" onkeypress="return validar(event,letras+'ñ')" maxlength="75" style="width:530px" /></td>
								</tr>								
								<tr>
					...
					<tr>
						<td colspan="2" align="center">
							...
							<table border="0" cellpadding="3"  cellspacing="3" width="100%" id="contenedor" style="display:">
								<tr ><td height="5"></td></tr>
								<tr>
									<td align="right" valign="top"><textarea name="hechos" id="hechos" onblur="formatotexto(this);" style="width:710px; height:90px" onkeyup="return maximaLongitud(this.id,400);"></textarea>&nbsp;<span class="mensaje">*</span>
					...
					<tr>
						<td colspan="2" align="center">
							...
							<table border="0" cellpadding="3"  cellspacing="3" width="100%" id="contenedor" style="display:">
								<tr ><td height="5"></td></tr>
								<tr>
									<td align="right" valign="top"><textarea name="fecha_hechos" id="fecha_hechos" onblur="formatotexto(this);" style="width:710px; height:50px" onkeyup="return maximaLongitud(this.id,200);"></textarea>&nbsp;<span class="mensaje">*</span></td>
								</tr>								
					...
					<tr>
						<td colspan="2" align="center">
							...
							<table border="0" cellpadding="3"  cellspacing="3" width="100%" id="contenedor" style="display:">
								...
								<tr>
									<td align="center" valign="top" colspan="2"><textarea name="pru_otro_descr" id="pru_otro_descr" readonly="false" onblur="formatotexto(this);"  onkeyup="return maximaLongitud(this.id,100);" style="width:710px; height:35px"></textarea></td>
								</tr>								
								<tr><td align="left" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:9px">M&aacute;ximo 100 Caracteres</span></td></tr>
...
$(document).ready(function()
{
	...
	if(valor==1){
		...
		mensaje=acentos('&iexcl;La Denuncia ha sido registrada Exitosamente!')
